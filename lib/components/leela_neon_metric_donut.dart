...
class _NeonDonutPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double realizedRatio = (realized / safeTarget).clamp(0, 1);
    final double timeTargetRatio = (timeTarget / safeTarget).clamp(0, 1);
  ...
  @override
  bool shouldRepaint(_NeonDonutPainter old) {
