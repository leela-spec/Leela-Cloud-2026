...
class _SCR_Path_MainState extends State<SCR_Path_Main> {
  ...
  void fn_openSidExplainer(String screenId) {
    // TODO: Implement Sid explainer functionality
  }
  ...
  void _navigateToSearch() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const SCR_Placeholder(p_title: 'Search'),
      ),
    );
  }
  ...
  void _navigateToSettings() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const SCR_Placeholder(p_title: 'Settings'),
      ),
    );
  }
        ...
        child: Column(
          children: [
            CMP_Nav_TopBar(
              ...
              p_onTapSid: fn_openSidExplainer,
